...
const MediaCard = ({ media, onRequest, isRequested, showReleaseDate = false }) => {
  ...
  return (
    <div
      ...
      className="bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group cursor-pointer border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
    ...
    >
      ...
      <div className="relative aspect-[2/3] bg-gray-700">
        ...
        {(!posterUrl || imageError) && (
          <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center border-2 border-dashed border-gray-600">
      ...
      <div className="p-5">
        ...
        <div className="mb-3">
          <h3 className="font-bold text-lg text-white line-clamp-2 leading-tight group-hover:text-blue-400 transition-colors min-h-[2.5rem]">
            {title}
          </h3>
        </div>
        ...
        <div className="mt-auto">
          {media.in_plex ? (
            <button
              ...
              className="w-full py-3 px-4 bg-green-900/30 text-green-400 rounded-lg text-sm font-semibold cursor-not-allowed flex items-center justify-center space-x-2 border border-green-800"
            >
            ...
            <button
              disabled
              onClick={(e) => e.stopPropagation()}
              className="w-full py-3 px-4 bg-amber-900/30 text-amber-400 rounded-lg text-sm font-semibold cursor-not-allowed flex items-center justify-center space-x-2 border border-amber-800"
            >
              <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 focus:ring-offset-gray-800 transition-all duration-200 flex items-center justify-center space-x-2 group"
            >
