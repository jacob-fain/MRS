        ...
        <div className="bg-gray-800 rounded-lg shadow-md p-6 mb-8 border border-gray-700">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="md:col-span-3">
              <h1 className="text-4xl font-bold text-white mb-4">{personDetails.name}</h1>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <select
                ...
                className="px-4 py-2 rounded-lg text-sm font-medium bg-gray-700 text-white border border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
