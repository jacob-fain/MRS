...
const TopRated = () => {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['top-rated', mediaType, page],
    queryFn: () => mediaType === 'movie'
      ? mediaService.getTopRatedMovies(page)
      : mediaService.getTopRatedTV(page),
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Top Rated</h1>
          <p className="text-gray-400">Browse the highest rated content</p>
        </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-red-300 mt-1">
                    Failed to load top rated content. Please try again.
                  </p>
                </div>
              </div>
            </div>
